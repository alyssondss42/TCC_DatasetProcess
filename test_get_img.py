...
# Selecionar apenas imagens que não possuem assinaturas
                ...
                if type(objects) is list:
                    ...
                    for obj in objects:
                        if obj['name'] == 'signature':
                            signature_list = []
                            break
                        elif obj['name'] != 'natural_image' and obj['name'] != 'signature':
                            signature_list.append(process_object_xml(obj))
                        else:  # Apenas "natural_image"
                            pass
                    ...
                    if objects['name'] != 'signature' and objects['name'] != 'natural_image':
...
if __name__ == '__main__':
    path_xml = r'C:\Users\Alysson\Downloads\Poli-UPE-20211112T232533Z-001\Poli-UPE\10º Período\TCC\Dataset\Full\AR_13K_dataset\test_xml\test_xml'
    path_img = r'C:\Users\Alysson\Downloads\Poli-UPE-20211112T232533Z-001\Poli-UPE\10º Período\TCC\Dataset\Full\AR_13K_dataset\test_images\test_images'
